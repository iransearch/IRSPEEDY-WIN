...
namespace v2rayN.Mode
{
    ...
    public class VmessItem
    {
        ...
        public string GetSummary()
        {
            ...
            switch (configType)
            {
                ...
                case EConfigType.Hysteria2:
                    var hysteriaPort = portEnd > port ? $"{port}-{portEnd}" : port.ToString();
                    summary += string.Format("{0}({1}:{2})", remarks, addr, hysteriaPort);
                    break;
        ...
        /// <summary>
        /// Hysteria2 port range end (inclusive); 0 when using a single port
        /// </summary>
        public int portEnd
        {
            get; set;
        ...
        /// <summary>
        /// Reality spiderX path (spx) from share link
        /// </summary>
        ...
        /// <summary>
        /// xhttp extra JSON from share link (decoded)
        /// </summary>
        public string transportExtra
        {
            get; set;
        }
